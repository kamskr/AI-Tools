...
class DataModel:
    ...
    def create_data_model(self):
        ...
        data_dict['cities'] = ['Warsaw', 'Krakow', 'Poznan', 'Wroclaw', 'Lodz', 'Bialystok', 'Katowice', 'Lublin']
        ...
        # ]
        data_dict['distance_matrix'] = [
            [0, 294, 310, 348, 130, 202, 294, 171],
            [294, 0, 456, 272, 251, 491, 81, 307],
            [310, 456, 0, 182, 218, 502, 376, 456],
            [348, 272, 182, 0, 216, 537, 191, 272],
            [130, 251, 218, 216, 0, 319, 213, 280],
            [202, 491, 502, 537, 319, 0, 492, 491],
            [294, 81, 376, 191, 213, 492, 0, 81],
            [171, 307, 456, 272, 280, 491, 81, 0],
        ]
